                            ...
                            <div class="d-row cpanel four-col">
                                ...
                                <div class="right-col">                                     
                                    ...
                                    <sj:a 
                                        ...
                                        <sj:submit   button="true" id="exportPdfbutton" name="exportPdfbutton"  value="Export PDF"   onclick="downloadOperaiton()" cssClass="btn default-button"/>
                                    </div>
                    ...
                    <s:form id="addnewhost" theme="simple" method="post" >
                        <div class="content-data">
                            ...
                            <div class="d-row">
                                ...
                                <div class="col-2 form-field">
                                    <s:select  name="listOpr" id="listOpr" list="%{operationList}" headerKey="0" headerValue="--Operation--" 
                            ...
                            <div class="d-row cpanel four-col">
                                ...
                                <div class="right-col">
                                    ...
                                    <div class="btn-wrap"><i class="fa fa-paper-plane" aria-hidden="true"></i><sj:submit  href="%{addurl}"  targets="divmsg" value="Send"  button="true"   cssClass="btn default-button"   cssStyle="height:25px"/></div>
