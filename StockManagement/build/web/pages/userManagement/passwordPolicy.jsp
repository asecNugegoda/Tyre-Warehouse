                        ...
                        <s:form theme="simple" id="pwdpolicyId" method="POST">
                            ...
                            <div class="d-row">
                                ...
                                <div class="right-col form-field">
                                    <s:textfield id="max_len" name="max_len" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Minimum Length<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="min_len" name="min_len" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Allow Special Characters<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="allowspecialcharacters" name="allowspecialcharacters" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Minimum Special Characters<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="min_spcl_chars" name="min_spcl_chars" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Maximum Special Characters<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="max_spcl_chars" name="max_spcl_chars" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Minimum Uppercase<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="min_upercase" name="min_upercase" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Minimum Lowercase<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="min_lowcase" name="min_lowcase" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <div class="d-row">
                                <label class="left-col form-label">Minimum Numeric Characters<sup class="required">*</sup></label>
                                <div class="right-col form-field">
                                    <s:textfield id="min_numerics" name="min_numerics" cssClass="txt-input width-10 text-right" disabled="true"/>
                                </div>
                            </div>
                            <!-- End -->
