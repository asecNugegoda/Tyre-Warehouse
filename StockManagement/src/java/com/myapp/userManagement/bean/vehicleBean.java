...
public class vehicleBean {
    ...
    /**
     * @param upCustomer the upCustomer to set
     */
    public void setUpCustomer(String upCustomer) {
        this.upCustomer = upCustomer;
    }

    /**
     * @return the upVehicleBrand
     */
    ...
    /**
     * @param upVehicleBrand the upVehicleBrand to set
     */
    ...
    /**
     * @return the upVehicleNumber
     */
    public String getUpVehicleNumber() {
        return upVehicleNumber;
    }

    /**
     * @param upVehicleNumber the upVehicleNumber to set
     */
    public void setUpVehicleNumber(String upVehicleNumber) {
        this.upVehicleNumber = upVehicleNumber;
    }
     ...
     */
    public List<vehicleBean> getGridModel() {
        return gridModel;
    }
     ...
     */
    public void setGridModel(List<vehicleBean> gridModel) {
    ...
    private String upVehicleNumber;
    ...
    // Table
    private List<vehicleBean> gridModel;
