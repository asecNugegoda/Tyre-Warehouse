...
public class BrandBean {
    ...
    private String upBrandId;
    private String upBrandName;
    ...
    // Table
    private List<BrandBean> gridModel;
   ...
   //***************Working Path*************
    ...
    /**
     * @return the upBrandId
     */
    public String getUpBrandId() {
        return upBrandId;
    }

    /**
     * @param upBrandId the upBrandId to set
     */
    public void setUpBrandId(String upBrandId) {
        this.upBrandId = upBrandId;
    }

    /**
     * @return the upBrandName
     */
    public String getUpBrandName() {
        return upBrandName;
    }

    /**
     * @param upBrandName the upBrandName to set
     */
    public void setUpBrandName(String upBrandName) {
        this.upBrandName = upBrandName;
    }
     ...
     */
    public List<BrandBean> getGridModel() {
        return gridModel;
    }
     ...
     */
    public void setGridModel(List<BrandBean> gridModel) {
