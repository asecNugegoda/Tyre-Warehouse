...
public class WarehouseBean {
    ...
    /**
     * @param upLocation the upLocation to set
     */
     ...
     */
    public List<WarehouseBean> getGridModel() {
        return gridModel;
    }
     ...
     */
    public void setGridModel(List<WarehouseBean> gridModel) {
    ...
    // Table
    private List<WarehouseBean> gridModel;
