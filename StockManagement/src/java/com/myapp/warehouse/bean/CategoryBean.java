...
public class CategoryBean {
    ...
    // Table
    private List<CategoryBean> gridModel;
   ...
   //***************Working Path*************
    ...
    /**
     * @param upCategoryId the upCategoryId to set
     */
    ...
    /**
     * @param upCategoryName the upCategoryName to set
     */
     ...
     */
    public List<CategoryBean> getGridModel() {
        return gridModel;
    }
     ...
     */
    public void setGridModel(List<CategoryBean> gridModel) {
